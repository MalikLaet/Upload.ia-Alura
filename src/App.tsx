    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 p-6 flex gap-4">
        <div className="flex  flex-col flex-1 gap-4">
          ...
          <p className="text-sm text-muted-foreground">Lembre-se: você pode utilizar a varíavel <code className="text-violet-400">{'{transcpition}'}</code> no seu pront para adicionar o contéudo da transcrição do vídeo selecionado</p>
        </div>
        ...
        <aside className="w-80 space-y-6">
          ...
          <div className="space-y-2">
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectItem value="titlle">Título</SelectItem>
